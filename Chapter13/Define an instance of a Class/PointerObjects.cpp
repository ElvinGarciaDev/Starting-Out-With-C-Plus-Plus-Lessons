...
int main()
{
    ...
    Rectangle *bedroom = nullptr;   //To point to the bedroom dimensions
    ...
    cin >> number;                  //Get the length
    bedroom->setLength(number);     //Store in kitchen object
    cout << "What is the bedroom's width? ";
    cin >> number;                  //Get the width
    bedroom->setWidth(number);      //Store in kitchen object

    //get the den dimensions
    cout << "What is the dens's length? ";
    cin >> number;                  //Get the length
    den->setLength(number);     //Store in kitchen object
    cout << "What is the den's width? ";
    cin >> number;                  //Get the width
    den->setWidth(number);      //Store in kitchen object
